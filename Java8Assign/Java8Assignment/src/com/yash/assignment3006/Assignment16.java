...
class Item2 {
	...
	protected Item2(int itemid, String item_name, String category_name, double price, String date_of_manufacturing,
...
public class Assignment16 {
	...
	public static void main(String[] args) {
		...
		items.add(new Item2(1, "bag", "travel", 3000, "22/10/2024", "22/10/2026"));
		items.add(new Item2(2, "mouse", "computer_accessories", 4500, "02/01/2020", "26/10/2029"));
		items.add(new Item2(3, "pen", "study", 500, "22/10/2020", "11/05/2027"));
		items.add(new Item2(4, "book", "study", 300, "15/04/2024", "16/09/2029"));
		items.add(new Item2(5, "table", "furniture", 6000, "23/10/2021", "23/10/2026"));
		...
		while (true) {
			...
			case 1:
				...
				List<Item2> i = items.stream().filter(e -> e.category_name.contains(category))
			...
			case 2:
				...
				List<Item2> ii = items.stream().filter(e -> e.item_name.startsWith(itemname))
						.collect(Collectors.toList());
			...
			case 4:
				...
				List<Item2> iii = items.stream().filter(m -> m.price > minrange && m.price < maxrange)
						.collect(Collectors.toList());
